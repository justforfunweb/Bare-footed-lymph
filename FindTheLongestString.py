...
# You have to find the longest string which is 
# lexicographically smallest and also all of its prefix strings 
...
# returns the longest string which is also lexicographically smallest.
